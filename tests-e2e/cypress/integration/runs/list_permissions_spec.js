...
describe('runs > list permissions', () => {
    let testTeam;
    let testOtherTeam;
    ...
    let sudoSysadminInTeam;
    let sudoSysadminNotInTeam;
    let droppedSudoSysadminInTeam;
    let droppedSudoSysadminNotInTeam;
    ...
    before(() => {
        cy.apiInitSetup().then(({team, user}) => {
            ...
            cy.apiCreateTeam('second-team', 'Second Team').then(({team: createdTeam}) => {
                ...
                // # in team 2. This is to ensure the list isn't empty for those users.
    ...
    describe('run with private channel from a public playbook', () => {
        ...
        describe('should be visible', () => {
            it.skip('to playbook members', () => {
                // Public playbooks currently have no members.
            });
            ...
            it.skip('to run followers', () => {
                // TODO: Programmatically follow a run.
            });
            ...
            it.skip('to sudo admins in the team', () => {
                assertRunIsVisible(run, sudoSysadminInTeam);
            });

            it.skip('to sudo admins not in the team', () => {
                // assertRunIsVisible(run, sudoSysadminNotInTeam);
            });

            it.skip('to dropped sudo admins in the team', () => {
                // assertRunIsVisible(run, droppedSudoSysadminInTeam);
            });
        });
        ...
        describe('should not be visible', () => {
            ...
            it('to admins not in the team', () => {
                assertRunIsNotVisible(run, sysadminNotInTeam);
            });

            it.skip('to dropped sudo admins not in the team', () => {
                // assertRunIsNotVisible(run, droppedSudoSysadminNotInTeam);
            });
        });
    });
